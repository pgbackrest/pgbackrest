...
--- output ---
    ...
    P00   INFO: P1-T1/1 - vm=none, module=common, test=wait
        ...
        P00   INFO: test command begin 2.59.1: [common/wait] --log-level=info --no-log-timestamp --repo-path=/home/vagrant/test/repo --scale=1 --test-path=/home/vagrant/test --vm=none --vm-id=0
...
--- output ---
    ...
    P00   INFO: test begin on x86_64 - log level info
    P00   INFO: Checking cache ghcr.io/pgbackrest/test:u22-base-x86_64-20260817A-23630805fe0d ...
    P00   INFO: Using cached ghcr.io/pgbackrest/test:u22-base-x86_64-20260817A-23630805fe0d image
