...
--- output ---
    ...
    P00   INFO: P1-T1/1 - vm=none, module=common, test=wait
        ...
        run 001 - waitNew(), waitMore, and waitFree()
            ...
            l0025 -         check remaining time
            l0026 -         check wait time
            l0027 -         check sleep time
            l0028 -         check sleep prev time
            l0029 -         check begin time
            l0035 -         lower range check
            l0036 -         upper range check
            l0038 -         free wait
            l0043 -     new wait = 1.1 sec
            l0044 -         check wait time
            l0045 -         check sleep time
            l0046 -         check sleep prev time
            l0047 -         check begin time
            l0053 -         lower range check
            l0054 -         upper range check
            l0056 -         free wait
