...
my $oConfigHelpData =
{
    ...
    command =>
    {
        ...
        'stanza-create' =>
        {
            ...
            description =>
                "After pgBackRest has been configured for use with a stanza, stanza-create must be run on the host where the " .
            ...
            option =>
            {
                ...
                'force' =>
                {
                    ...
                    description =>
                        "If a required information file does not exist for some reason in the stanza repository yet backups or " .
                            "arhives do exist, then this option can be used to force the information files to be created from " .
                            "the existing data in the directory."
                },
