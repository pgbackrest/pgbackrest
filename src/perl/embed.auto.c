...
static const EmbeddedModule embeddedModule[] =
{
    ...
    },
    {
        ...
        .data =
            ...
            "syswrite(*STDOUT, \"FILE: $strFile, SET MASTER: \". $self->boolGet($strSection, $strFile, MANIFEST_SUBKEY_MASTER) . \"\\n\");\n"
            "}\n"
            "\n"
            "\n"
            "if ($cType eq 'l')\n"
            ...
            "syswrite(*STDOUT, \"FILEADD: $strManifestFile, SET MASTER: \". $self->boolGet(MANIFEST_SECTION_TARGET_FILE, $strManifestFile, MANIFEST_SUBKEY_MASTER) . \"\\n\");\n"
            "}\n"
            "\n"
            "\n"
            "\n"
            ...
            "{\n"
            "syswrite(*STDOUT, \"REMOVE: [$strSection] [$strSubKey] $strFile, MAX: $strMaxValue\\n\");\n"
