...
static const EmbeddedModule embeddedModule[] =
{
    ...
    },
    {
        ...
        .data =
            ...
            "}\n"
            "\n"
            "elsif ($oAbortedManifest->get(INI_SECTION_BACKREST, INI_KEY_BACKREST_FORMAT) ne BACKREST_FORMAT)\n"
            "{\n"
            "$strKey =  INI_KEY_BACKREST_FORMAT;\n"
            "$strValueNew = BACKREST_FORMAT;\n"
            "$strValueAborted = $oAbortedManifest->get(INI_SECTION_BACKREST, INI_KEY_BACKREST_FORMAT);\n"
            "}\n"
            "\n"
    ...
    },
    {
        ...
        .data =
            ...
            "use constant INFO_BACKUP_KEY_FORMAT => INI_KEY_BACKREST_FORMAT;\n"
            ...
            "$oBackupManifest->numericGet(INI_SECTION_BACKREST, INI_KEY_BACKREST_FORMAT));\n"
    ...
    },
    {
        ...
        .data =
            ...
            "\n"
            "use constant INI_KEY_BACKREST_CHECKSUM => 'backrest-checksum';\n"
            "push @EXPORT, qw(INI_KEY_BACKREST_CHECKSUM);\n"
            "use constant INI_KEY_BACKREST_FORMAT => 'backrest-format';\n"
            "push @EXPORT, qw(INI_KEY_BACKREST_FORMAT);\n"
            ...
            "{\n"
            "$self->numericSet(INI_SECTION_BACKREST, INI_KEY_BACKREST_FORMAT, undef, $self->{iInitFormat});\n"
            ...
            "{\n"
            "\n\n"
            "my $strChecksum = $self->get(INI_SECTION_BACKREST, INI_KEY_BACKREST_CHECKSUM, undef, false);\n"
            ...
            "}\n"
            "\n\n"
            "my $iFormat = $self->get(INI_SECTION_BACKREST, INI_KEY_BACKREST_FORMAT, undef, false, 0);\n"
            "\n"
            ...
            "my $self = shift;\n"
            "\n\n"
            "delete($self->{oContent}{&INI_SECTION_BACKREST}{&INI_KEY_BACKREST_CHECKSUM});\n"
            "\n\n"
            "$self->{oContent}{&INI_SECTION_BACKREST}{&INI_KEY_BACKREST_CHECKSUM} =\n"
            "cryptoHashOne('sha1', JSON::PP->new()->canonical()->allow_nonref()->encode($self->{oContent}));\n"
            "\n"
            "return $self->{oContent}{&INI_SECTION_BACKREST}{&INI_KEY_BACKREST_CHECKSUM};\n"
            "}\n"
            "\n\n\n\n"
            "sub get\n"
            "{\n"
    ...
    },
    {
        ...
        .data =
            ...
            "{\n"
            "&INFO_KEY_FORMAT =>\n"
            "$oBackupInfo->numericGet(INFO_BACKUP_SECTION_BACKUP_CURRENT, $strBackup, INI_KEY_BACKREST_FORMAT),\n"
            "&INFO_KEY_VERSION =>\n"
