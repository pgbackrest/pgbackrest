...
FV_EXTERN void iniParse(Ini *this, const String *content);

// Set an ini value
FV_EXTERN void iniSet(Ini *this, const String *section, const String *key, const String *value);
