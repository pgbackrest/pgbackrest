...
FV_EXTERN void lockWriteData(LockType lockType, LockWriteDataParam param);
...
FV_EXTERN LockReadResult lockReadFile(const String *lockFile, LockReadFileParam param);

// Wrapper that generates the lock filename before calling lockReadFile()
FV_EXTERN LockReadResult lockRead(const String *lockPath, const String *stanza, LockType lockType);
