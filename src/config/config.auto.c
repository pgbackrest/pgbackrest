...
STRING_EXTERN(CFGOPT_PG_DEFAULT_STR,                                CFGOPT_PG_DEFAULT);
...
STRING_EXTERN(CFGOPT_REPO_DEFAULT_STR,                              CFGOPT_REPO_DEFAULT);
...
(
    ...
    CONFIG_OPTION
    (
        CONFIG_OPTION_NAME("repo-default")
    )
