...
FV_EXTERN void configOptionProtocol(PackRead *param, ProtocolServer *server);

// Get option values from a remote process
FV_EXTERN VariantList *configOptionRemote(ProtocolClient *client, const VariantList *paramList);
