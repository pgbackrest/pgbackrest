...
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB3_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB3_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB3_USER` | `"postgres"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB4_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB4_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB4_USER` | `"postgres"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB5_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB5_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB5_USER` | `"postgres"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB6_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB6_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB6_USER` | `"postgres"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB7_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB7_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB7_USER` | `"postgres"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB8_CONFIG` | `"/etc/pgbackrest.conf"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB8_PORT` | `"5432"` |
| cfgOptionRuleDefault | _\<ANY\>_ | `CFGOPT_DB8_USER` | `"postgres"` |
...
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleDepend | _\<ANY\>_ | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB3_CMD` | `CFGOPT_DB3_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB3_CONFIG` | `CFGOPT_DB3_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB3_SSH_PORT` | `CFGOPT_DB3_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB3_USER` | `CFGOPT_DB3_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB4_CMD` | `CFGOPT_DB4_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB4_CONFIG` | `CFGOPT_DB4_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB4_SSH_PORT` | `CFGOPT_DB4_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB4_USER` | `CFGOPT_DB4_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB5_CMD` | `CFGOPT_DB5_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB5_CONFIG` | `CFGOPT_DB5_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB5_SSH_PORT` | `CFGOPT_DB5_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB5_USER` | `CFGOPT_DB5_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB6_CMD` | `CFGOPT_DB6_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB6_CONFIG` | `CFGOPT_DB6_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB6_SSH_PORT` | `CFGOPT_DB6_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB6_USER` | `CFGOPT_DB6_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB7_CMD` | `CFGOPT_DB7_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB7_CONFIG` | `CFGOPT_DB7_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB7_SSH_PORT` | `CFGOPT_DB7_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB7_USER` | `CFGOPT_DB7_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB8_CMD` | `CFGOPT_DB8_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB8_CONFIG` | `CFGOPT_DB8_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB8_SSH_PORT` | `CFGOPT_DB8_HOST` |
| cfgOptionRuleDependOption | _\<ANY\>_ | `CFGOPT_DB8_USER` | `CFGOPT_DB8_HOST` |
...
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB3_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB3_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB3_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB3_USER` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB4_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB4_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB4_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB4_USER` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB5_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB5_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB5_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB5_USER` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB6_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB6_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB6_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB6_USER` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB7_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB7_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB7_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB7_USER` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB8_CMD` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB8_CONFIG` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB8_SSH_PORT` | `0` |
| cfgOptionRuleDependValueTotal | _\<ANY\>_ | `CFGOPT_DB8_USER` | `0` |
...
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB3_PATH` | `"does this stanza exist?"` |
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB4_PATH` | `"does this stanza exist?"` |
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB5_PATH` | `"does this stanza exist?"` |
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB6_PATH` | `"does this stanza exist?"` |
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB7_PATH` | `"does this stanza exist?"` |
| cfgOptionRuleHint | _\<ANY\>_ | `CFGOPT_DB8_PATH` | `"does this stanza exist?"` |
...
| cfgOptionRulePrefix | `CFGOPT_DB3_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB3_USER` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB4_USER` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB5_USER` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB6_USER` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB7_USER` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_CMD` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_CONFIG` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_HOST` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_SOCKET_PATH` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_SSH_PORT` | `"db"` |
| cfgOptionRulePrefix | `CFGOPT_DB8_USER` | `"db"` |
...
| cfgOptionRuleSection | `CFGOPT_DB3_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB3_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB3_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB3_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB3_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB3_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB3_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB3_USER` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB4_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB4_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB4_USER` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB5_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB5_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB5_USER` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB6_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB6_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB6_USER` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB7_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB7_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB7_USER` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_CMD` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB8_CONFIG` | `"global"` |
| cfgOptionRuleSection | `CFGOPT_DB8_HOST` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_SOCKET_PATH` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_SSH_PORT` | `"stanza"` |
| cfgOptionRuleSection | `CFGOPT_DB8_USER` | `"stanza"` |
...
| cfgOptionRuleType | `CFGOPT_DB3_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB3_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB3_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB3_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB3_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB3_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB3_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB3_USER` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB4_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB4_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB4_USER` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB5_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB5_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB5_USER` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB6_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB6_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB6_USER` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB7_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB7_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB7_USER` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_CMD` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_CONFIG` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_HOST` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB8_SOCKET_PATH` | `CFGOPTRULE_TYPE_STRING` |
| cfgOptionRuleType | `CFGOPT_DB8_SSH_PORT` | `CFGOPTRULE_TYPE_INTEGER` |
| cfgOptionRuleType | `CFGOPT_DB8_USER` | `CFGOPTRULE_TYPE_STRING` |
...
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_GET` | `CFGOPT_DB8_PATH` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_ARCHIVE_PUSH` | `CFGOPT_DB8_SSH_PORT` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_BACKUP` | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_CHECK` | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_EXPIRE` | `CFGOPT_DB8_SSH_PORT` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_LOCAL` | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB3_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB4_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB5_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB6_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB7_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB8_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_REMOTE` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_RESTORE` | `CFGOPT_DB8_PATH` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_CREATE` | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB3_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB4_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB5_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB6_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB7_USER` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_SOCKET_PATH` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STANZA_UPGRADE` | `CFGOPT_DB8_USER` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_START` | `CFGOPT_DB8_SSH_PORT` | `true` |
...
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB3_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB3_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB3_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB3_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB4_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB4_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB4_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB4_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB5_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB5_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB5_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB5_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB6_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB6_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB6_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB6_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB7_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB7_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB7_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB7_SSH_PORT` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB8_CMD` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB8_CONFIG` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB8_HOST` | `true` |
| cfgOptionRuleValid | `CFGCMD_STOP` | `CFGOPT_DB8_SSH_PORT` | `true` |
