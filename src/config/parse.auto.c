...
static const ParseRuleOption parseRuleOption[] =
{
    ...
    (
        ...
        PARSE_RULE_OPTION_COMMAND_ROLE_OTHER_LIST
        (
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdBackup, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdBackup, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdBackup, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleRemote)
        )
    )
    ...
    (
        ...
        PARSE_RULE_OPTION_COMMAND_ROLE_OTHER_LIST
        (
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleRemote)
        )
    )
    ...
    (
        ...
        (
            ...
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleRemote)
        )
    )
    ...
    (
        ...
        (
            ...
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdCheck, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdExpire, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdExpire, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdExpire, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdInfo, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdInfo, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdInfo, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoCreate, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoCreate, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoCreate, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoGet, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoGet, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoGet, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoLs, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoLs, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoLs, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoPut, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoPut, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoPut, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoRm, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoRm, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRepoRm, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdRestore, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaCreate, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaDelete, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaDelete, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaDelete, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleRemote)
        )
    )
    ...
    (
        ...
        (
            ...
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStanzaUpgrade, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStart, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStart, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStart, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStop, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStop, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdStop, cfgCmdRoleRemote)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleAsync)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleLocal)
            PARSE_RULE_OPTION_COMMAND_ROLE_OTHER(cfgCmdVerify, cfgCmdRoleRemote)
        )
