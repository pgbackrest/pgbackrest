...
static const ParseRuleOption parseRuleOption[CFG_OPTION_TOTAL] =
{
    ...
    PARSE_RULE_OPTION
    (
        PARSE_RULE_OPTION_NAME("repo-gcs-ca-file"),
        PARSE_RULE_OPTION_TYPE(cfgOptTypeString),
        PARSE_RULE_OPTION_REQUIRED(false),
        PARSE_RULE_OPTION_SECTION(cfgSectionGlobal),
        PARSE_RULE_OPTION_GROUP_MEMBER(true),
    ...
    PARSE_RULE_OPTION
    (
        PARSE_RULE_OPTION_NAME("repo-gcs-ca-path"),
        PARSE_RULE_OPTION_TYPE(cfgOptTypePath),
        PARSE_RULE_OPTION_REQUIRED(false),
        PARSE_RULE_OPTION_SECTION(cfgSectionGlobal),
        PARSE_RULE_OPTION_GROUP_MEMBER(true),
...
static const struct option optionList[] =
{
    ...
    // -----------------------------------------------------------------------------------------------------------------------------
    {
        .name = "repo1-gcs-ca-file",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "reset-repo1-gcs-ca-file",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "repo2-gcs-ca-file",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "reset-repo2-gcs-ca-file",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "repo3-gcs-ca-file",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "reset-repo3-gcs-ca-file",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "repo4-gcs-ca-file",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },
    {
        .name = "reset-repo4-gcs-ca-file",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaFile,
    },

    // repo-gcs-ca-path option
    // -----------------------------------------------------------------------------------------------------------------------------
    {
        .name = "repo1-gcs-ca-path",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "reset-repo1-gcs-ca-path",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "repo2-gcs-ca-path",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "reset-repo2-gcs-ca-path",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "repo3-gcs-ca-path",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "reset-repo3-gcs-ca-path",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "repo4-gcs-ca-path",
        .has_arg = required_argument,
        .val = PARSE_OPTION_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    {
        .name = "reset-repo4-gcs-ca-path",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsCaPath,
    },
    ...
    // -----------------------------------------------------------------------------------------------------------------------------
    {
        .name = "repo1-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "no-repo1-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_NEGATE_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "reset-repo1-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (0 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "repo2-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "no-repo2-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_NEGATE_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "reset-repo2-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (1 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "repo3-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "no-repo3-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_NEGATE_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "reset-repo3-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (2 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "repo4-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "no-repo4-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_NEGATE_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
    {
        .name = "reset-repo4-gcs-verify-tls",
        .val = PARSE_OPTION_FLAG | PARSE_RESET_FLAG | (3 << PARSE_KEY_IDX_SHIFT) | cfgOptRepoGcsVerifyTls,
    },
