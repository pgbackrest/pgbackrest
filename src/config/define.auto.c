...
(
    ...
    (
        ...
        CFGDEFDATA_OPTION_HELP_SUMMARY("Set repository.")
        CFGDEFDATA_OPTION_HELP_DESCRIPTION
        (
            ...
            "For example, this option may be used to perform a restore from a specific repository, rather than letting pgBackRest "
                "choose.\n"
            "\n"
            "Note that some commands, e.g. archive-push, are intended to operate on all repositories and will ignore this option."
        )
