...
void dbSyncProtocol(const VariantList *paramList, ProtocolServer *server);
...
#define PROTOCOL_COMMAND_DB_SYNC                                    STRID5("db-s", 0x9ec440)
...
#define PROTOCOL_SERVER_HANDLER_DB_LIST                                                                                            \
    ...
    {.command = PROTOCOL_COMMAND_DB_SYNC, .handler = dbSyncProtocol},                                                              \
