...
static void
backupResumeClean(
    StorageList *const storageList, Manifest *const manifest, const Manifest *const manifestResume, const CompressType compressType,
        ...
        while (storageListMore(storageList))
        {
            ...
            switch (info.type)
            {
                ...
                case storageTypePath:
                {
                    ...
                    {
                        backupResumeClean(
                            storageInfoListP(storageRepo(), backupPath, .sortOrder = sortOrderAsc), manifest, manifestResume,
