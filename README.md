...
pgBackRest [v2.52.1](https://github.com/pgbackrest/pgbackrest/releases/tag/release/2.52.1) is the current stable release. Release notes are on the [Releases](http://www.pgbackrest.org/release.html) page.
