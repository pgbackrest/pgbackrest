...
pgBackRest [v1.23](https://github.com/pgbackrest/pgbackrest/releases/tag/release/1.23) is the current stable release. Release notes are on the [Releases](http://www.pgbackrest.org/release.html) page.
