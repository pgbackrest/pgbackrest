...
pgBackRest [v1.29](https://github.com/pgbackrest/pgbackrest/releases/tag/release/1.29) is the current stable release. Release notes are on the [Releases](http://www.pgbackrest.org/release.html) page.
