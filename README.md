...
pgBackRest [v2.55.0](https://github.com/pgbackrest/pgbackrest/releases/tag/release/2.55.0) is the current stable release. Release notes are on the [Releases](http://www.pgbackrest.org/release.html) page.
