...
testRun(void)
{
    ...
    if (testBegin("infoManifestNewBuild()"))
    {
        ...
        //
        // Storage *storagePg = storageDriverPosixInterface(
        //     storageDriverPosixNew(strNewFmt("%s/pg", testPath()), STORAGE_MODE_FILE_DEFAULT, STORAGE_MODE_PATH_DEFAULT, false,
        //     NULL));
        // Storage *storagePgWrite = storageDriverPosixInterface(
