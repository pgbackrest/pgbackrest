...
testRun(void)
{
    ...
    if (testBegin("bldPgParse() and bldPgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "#define FORK_POSTGRESQL\n"
            "\n"
            "#define enum1                                                       enum1_90PostgreSQL\n"
            "#define enum2                                                       enum2_90PostgreSQL\n"
            "#define enum_type                                                   enum_type_90PostgreSQL\n"
            "#define int64                                                       int64_90PostgreSQL\n"
            "#define struct_type                                                 struct_type_90PostgreSQL\n"
            "\n"
            "#include \"postgres/interface/version.intern.h\"\n"
            "\n"
            "PG_INTERFACE_CONTROL_IS(90PostgreSQL);\n"
            "PG_INTERFACE_CONTROL(90PostgreSQL);\n"
            "\n"
            "#undef enum1\n"
            "#undef enum2\n"
            "#undef enum_type\n"
            ...
            "        .fork = CFGOPTVAL_FORK_POSTGRESQL,\n"
            "\n"
            "        .controlIs = pgInterfaceControlIs90PostgreSQL,\n"
            "        .control = pgInterfaceControl90PostgreSQL,\n"
            "    },\n"
            "};\n");
    }
