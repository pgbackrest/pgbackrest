...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            COMMENT_BLOCK_END "\n"
            "#define CFGOPTVAL_BOOL_LIKE_N                                       0\n"
            "#define CFGOPTVAL_BOOL_LIKE_N_STRID                                 STRID5S(\"n\", 0, 0xe2)\n"
            "#define CFGOPTVAL_BOOL_LIKE_N_Z                                     \"n\"\n"
            "#define CFGOPTVAL_BOOL_LIKE_CHECK                                   1\n"
            "#define CFGOPTVAL_BOOL_LIKE_CHECK_STRID                             STRID5S(\"check\", 1, 0xb195034)\n"
            "#define CFGOPTVAL_BOOL_LIKE_CHECK_Z                                 \"check\"\n"
            "#define CFGOPTVAL_BOOL_LIKE_Y                                       2\n"
            "#define CFGOPTVAL_BOOL_LIKE_Y_STRID                                 STRID5S(\"y\", 2, 0x196)\n"
            ...
            "\n"
            "#define CFGOPTVAL_ARCHIVE_GET_COMPRESS_NETWORK_BZ2                  0\n"
            "#define CFGOPTVAL_ARCHIVE_GET_COMPRESS_NETWORK_BZ2_STRID            STRID5S(\"bz2\", 0, 0x73422)\n"
            "#define CFGOPTVAL_ARCHIVE_GET_COMPRESS_NETWORK_BZ2_Z                \"bz2\"\n"
            "\n"
        ...
        TEST_STORAGE_GET(
            ...
            "        (\n"
            "            PARSE_RULE_OPTION_COMMAND_INTERNAL(Backup, true),\n"
            "        )\n"
            "\n"
            "        PARSE_RULE_OPTION_COMMAND_ROLE_MAIN_VALID_LIST\n"
            "        (\n"
