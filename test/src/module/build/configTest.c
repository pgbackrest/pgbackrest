...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "                (\n"
            "                    PARSE_RULE_VAL_INT(32768),\n"
            "                ),\n"
            "\n"
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(32768),\n"
            "                    PARSE_RULE_VAL_STR(QT_32768_QT),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
            ...
            "                PARSE_RULE_OPTIONAL_ALLOW_LIST\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(8192),\n"
            "                    PARSE_RULE_VAL_INT(16384),\n"
            ...
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_STR(CFGOPTDEF_CONFIG_PATH_SP_QT_FS_DT_QT_SP_PROJECT_CONFIG_FILE),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
            ...
            "                PARSE_RULE_OPTIONAL_ALLOW_RANGE\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(5000),\n"
            "                    PARSE_RULE_VAL_INT(50000),\n"
            "                ),\n"
            "\n"
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(30000),\n"
            "                    PARSE_RULE_VAL_STR(QT_30_QT),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
            ...
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(20000),\n"
            "                    PARSE_RULE_VAL_STR(QT_20_QT),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
            ...
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_INT(10000),\n"
            "                    PARSE_RULE_VAL_STR(QT_10_QT),\n"
            "                ),\n"
            "            ),\n"
            "        ),\n"
            "    ),\n"
