...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "                (\n"
            "                    PARSE_RULE_VAL_STRID(parseRuleValStrIdN),\n"
            "                    PARSE_RULE_VAL_STRID(parseRuleValStrIdCheck),\n"
            "                    PARSE_RULE_VAL_STRID(parseRuleValStrIdY),\n"
            "                ),\n"
            "\n"
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_STRID(parseRuleValStrIdN),\n"
            "                    PARSE_RULE_VAL_STR(parseRuleValStrQT_n_QT),\n"
            "                ),\n"
            "            ),\n"
            "        ),\n"
            "    ),\n"
