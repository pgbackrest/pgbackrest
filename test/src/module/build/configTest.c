...
testRun(void)
{
    ...
    if (testBegin("bldCfgParse() and bldCfgRender()"))
    {
        ...
        TEST_STORAGE_GET(
            ...
            "    parseRuleValStrCFGOPTDEF_CONFIG_PATH_SP_QT_FS_DT_DS_CO_NT_PL_QT_SP_PROJECT_CONFIG_FILE,\n"
            "} ParseRuleValueStr;\n"
            "\n"
            COMMENT_BLOCK_BEGIN "\n"
            "Rule StringIds\n"
            ...
            "                PARSE_RULE_OPTIONAL_DEFAULT\n"
            "                (\n"
            "                    PARSE_RULE_VAL_STR(CFGOPTDEF_CONFIG_PATH_SP_QT_FS_DT_DS_CO_NT_PL_QT_SP_PROJECT_CONFIG_FILE),\n"
            "                ),\n"
            "            ),\n"
            "\n"
            "            PARSE_RULE_OPTIONAL_GROUP\n"
