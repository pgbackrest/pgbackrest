...
testRun(void)
{
    ...
    if (testBegin("backupJobResult()"))
    {
        ...
        ProtocolParallelJob *job = protocolParallelJobNew(VARSTRDEF("key"), protocolCommandNew(STR6ID1('X')));
        ...
        job = protocolParallelJobNew(VARSTRDEF("pg_data/test"), protocolCommandNew(STR6ID1('X')));
