...
testRun(void)
{
    ...
    if (testBegin("backupJobResult()"))
    {
        ...
        ProtocolParallelJob *job = protocolParallelJobNew(VARSTRDEF("key"), protocolCommandNew(STRID1('X')));
        ...
        job = protocolParallelJobNew(VARSTRDEF("pg_data/test"), protocolCommandNew(STRID1('X')));
