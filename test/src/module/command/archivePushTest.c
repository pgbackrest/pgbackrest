...
testRun(void)
{
    ...
    if (testBegin("archivePushCheck()"))
    {
        ...
        TEST_RESULT_UINT(cipherInfoType(repoData->cipherInfo), cipherTypeNone, "check cipher type");
        TEST_RESULT_PTR(cipherInfoPass(repoData->cipherInfo), NULL, "check cipher pass (not set in this test)");
        ...
        TEST_RESULT_UINT(cipherInfoType(repoData->cipherInfo), cipherTypeNone, "check repo2 cipher pass");
        TEST_RESULT_PTR(cipherInfoPass(repoData->cipherInfo), NULL, "check repo2 cipher pass (not set in this test)");
        ...
        TEST_RESULT_UINT(cipherInfoType(repoData->cipherInfo), cipherTypeNone, "check repo4 cipher type");
        TEST_RESULT_PTR(cipherInfoPass(repoData->cipherInfo), NULL, "check repo4 cipher pass (not set in this test)");
    }
