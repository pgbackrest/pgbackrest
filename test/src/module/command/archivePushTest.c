...
testRun(void)
{
    ...
    if (testBegin("archivePushReadyList(), archivePushProcessList(), and archivePushDrop()"))
    {
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_10}, walBuffer);
    ...
    if (testBegin("Synchronous cmdArchivePush() and archivePushFile()"))
    {
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_10}, walBuffer1);
        ...
        memset(bufPtr(walBuffer1), 0, bufSize(walBuffer1));
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_11, .systemId = 1}, walBuffer1);
        ...
        memset(bufPtr(walBuffer1), 0, bufSize(walBuffer1));
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_11}, walBuffer1);
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_11}, walBuffer2);
    ...
    if (testBegin("Asynchronous cmdArchivePush() and cmdArchivePushAsync()"))
    {
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_94}, walBuffer1);
        const char *walBuffer1Sha1 = strZ(strNewEncode(encodingHex, cryptoHashOne(hashTypeSha1, walBuffer1)));
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_94}, walBuffer2);
        const char *walBuffer2Sha1 = strZ(strNewEncode(encodingHex, cryptoHashOne(hashTypeSha1, walBuffer2)));
        ...
        hrnPgWalToBuffer((HrnPgWal){.version = PG_VERSION_94}, walBuffer3);
