...
testRun(void)
{
    ...
    if (testBegin("archivePushCheck()"))
    {
        ...
        TEST_RESULT_UINT(cipherSpecType(repoData->cipherSpec), cipherTypeNone, "check cipher type");
        TEST_RESULT_PTR(cipherSpecPass(repoData->cipherSpec), NULL, "check cipher pass (not set in this test)");
        ...
        TEST_RESULT_UINT(cipherSpecType(repoData->cipherSpec), cipherTypeNone, "check repo2 cipher pass");
        TEST_RESULT_PTR(cipherSpecPass(repoData->cipherSpec), NULL, "check repo2 cipher pass (not set in this test)");
        ...
        TEST_RESULT_UINT(cipherSpecType(repoData->cipherSpec), cipherTypeNone, "check repo4 cipher type");
        TEST_RESULT_PTR(cipherSpecPass(repoData->cipherSpec), NULL, "check repo4 cipher pass (not set in this test)");
    }
