...
testRun(void)
{
    ...
    if (testBegin("listRender()"))
    {
        ...
        TEST_RESULT_STR_Z(
            ...
            "----------------------------------------------------------------------------------------------------------------------"
            "--------------------------------------------------------\n"
            " Repo   Version  ID                                 Recovery Time             Type  Cipher  TLI  Time     DB size  Bac"
            "kup size  Zratio  Start LSN       Stop LSN        Status\n"
            "----------------------------------------------------------------------------------------------------------------------"
            "--------------------------------------------------------\n"
            " repo1  15       20260819-010003F                   2026-02-02 03:45:00+0000  full  none    1/0    1h:5m  372.5GB     "
            " 122.9GB    3.03  2F728/88000130  2F729/F957E7E8  OK\n"
            " repo1  15       20260819-010003F_20260820-010004D  2026-02-03 03:04:52+0000  diff  none    1/1  24m:52s  372.5GB     "
            "  49.8GB    2.71  2F7A2/CC000130  2F7A3/D3F87C68  ERROR\n"
            " repo1  15       20260819-010003F_20260821-010005I  2026-02-04 02:44:03+0000  incr  none    1/1    4m:3s  372.5GB     "
            "      0B       -  2F7C8/A80780E8  2F7C8/B9D71858  OK\n"
            " repo1  9.6      20260822-010006F                   2026-02-05 02:40:30+0000  full  none    -        30s      1KB     "
            "    512B    2.00  -               -               -\n"
            " repo1  9.6      20260822-010006F_20260822-020009I  2026-02-06 02:42:00+0000  incr  none    1/0    2m:0s      2KB     "
            "    512B    2.00  -               -               OK\n"
            " repo1  -        20260823-010007F_20260823-020008I  2026-02-07 02:41:00+0000  incr  none    2/0    1m:0s      2KB     "
            "    512B    2.00  -               -               OK\n",
            "single repo");
        ...
        TEST_RESULT_STR_Z(
            ...
            "----------------------------------------------------------------------------------------------------------------------"
            "--------------------------\n"
            " Repo   Version  ID                Recovery Time             Type  Cipher  TLI  Time  DB size  Backup size  Zratio  St"
            "art LSN  Stop LSN   Status\n"
            "----------------------------------------------------------------------------------------------------------------------"
            "--------------------------\n"
            " repo2  15       20260810-010001F  2026-01-21 12:53:30+0000  full  none    1/0   10s      2KB          1KB    2.00  1/"
            "1000028  1/10000F8  OK\n"
            "\n"
            "STANZA 'demo'\n"
            "----------------------------------------------------------------------------------------------------------------------"
            "--------------------------------------------------------\n"
            ...
            " repo1  15       20260819-010003F                   2026-02-02 03:45:00+0000  full  none    1/0    1h:5m  372.5GB     "
            " 122.9GB    3.03  2F728/88000130  2F729/F957E7E8  OK\n"
            " repo2  15       20260819-010003F                   2026-02-02 03:45:00+0000  full  none    1/0    1h:5m  372.5GB     "
            " 122.9GB    3.03  2F728/88000130  2F729/F957E7E8  OK\n"
            " repo1  15       20260819-010003F_20260820-010004D  2026-02-03 03:04:52+0000  diff  none    1/1  24m:52s  372.5GB     "
            "  49.8GB    2.71  2F7A2/CC000130  2F7A3/D3F87C68  ERROR\n"
            " repo1  15       20260819-010003F_20260821-010005I  2026-02-04 02:44:03+0000  incr  none    1/1    4m:3s  372.5GB     "
        ...
        TEST_RESULT_STR_Z(
            ...
            "----------------------------------------------------------------------------------------------------------------------"
            "-------------------------------------\n"
            " Repo   Version  ID                Recovery Time             Type  Cipher  TLI  Time   DB size  Backup size  Zratio  S"
            "tart LSN       Stop LSN        Status\n"
            "----------------------------------------------------------------------------------------------------------------------"
            "-------------------------------------\n"
            " repo2  15       20260819-010003F  2026-02-02 03:45:00+0000  full  none    1/0  1h:5m  372.5GB      122.9GB    3.03  2"
            "F728/88000130  2F729/F957E7E8  OK\n",
            "repo option");
        ...
        HRN_FORK_BEGIN()
        {
            ...
            HRN_FORK_PARENT_BEGIN()
            {
                ...
                TEST_RESULT_STR_Z(
                    ...
                    "--------------------------------------------------------------------------------------------------------------"
                    "----------------------------------\n"
                    " Repo   Version  ID                Recovery Time             Type  Cipher  TLI  Time  DB size  Backup size  Zr"
                    "atio  Start LSN  Stop LSN   Status\n"
                    "--------------------------------------------------------------------------------------------------------------"
                    "----------------------------------\n"
                    " repo2  15       20260810-010001F  2026-01-21 12:53:30+0000  full  none    1/0   10s      2KB          1KB    "
                    "2.00  1/1000028  1/10000F8  OK\n"
                    "\n"
                    "STANZA 'beta'\n"
                    "--------------------------------------------------------------------------------------------------------------"
                    "---------\n"
                    " Repo   Version  ID  Recovery Time  Type  Cipher  TLI  Time  DB size  Backup size  Zratio  Start LSN  Stop LSN"
                    "  Status\n"
                    "--------------------------------------------------------------------------------------------------------------"
                    "---------\n"
                    " repo2  -        -   -              -     none    -       -        -            -       -  -          -       "
                    ...
                    "--------------------------------------------------------------------------------------------------------------"
                    "----------------------------------------------------------------\n"
                    " Repo   Version  ID                                 Recovery Time             Type  Cipher  TLI  Time     DB s"
                    "ize  Backup size  Zratio  Start LSN       Stop LSN        Status\n"
                    "--------------------------------------------------------------------------------------------------------------"
                    "----------------------------------------------------------------\n"
                    " repo1  15       20260819-010003F                   2026-02-02 03:45:00+0000  full  none    1/0    1h:5m  372."
                    "5GB      122.9GB    3.03  2F728/88000130  2F729/F957E7E8  OK\n"
                    " repo2  15       20260819-010003F                   2026-02-02 03:45:00+0000  full  none    1/0    1h:5m  372."
                    "5GB      122.9GB    3.03  2F728/88000130  2F729/F957E7E8  OK\n"
                    " repo1  15       20260819-010003F_20260820-010004D  2026-02-03 03:04:52+0000  diff  none    1/1  24m:52s  372."
                    "5GB       49.8GB    2.71  2F7A2/CC000130  2F7A3/D3F87C68  ERROR\n"
                    " repo1  15       20260819-010003F_20260821-010005I  2026-02-04 02:44:03+0000  incr  none    1/1    4m:3s  372."
                    "5GB           0B       -  2F7C8/A80780E8  2F7C8/B9D71858  OK\n"
                    " repo1  9.6      20260822-010006F                   2026-02-05 02:40:30+0000  full  none    -        30s      "
                    "1KB         512B    2.00  -               -               -\n"
                    " repo1  9.6      20260822-010006F_20260822-020009I  2026-02-06 02:42:00+0000  incr  none    1/0    2m:0s      "
                    "2KB         512B    2.00  -               -               OK\n"
                    " repo1  -        20260823-010007F_20260823-020008I  2026-02-07 02:41:00+0000  incr  none    2/0    1m:0s      "
                    "2KB         512B    2.00  -               -               OK\n"
                    " repo1  -        -                                  -                         -     none    -          -      "
                    "3MB            -       -  -               -               78.46%\n"
                    " repo2  -        -                                  -                         -     none    -          -      "
        ...
        // -------------------------------------------------------------------------------------------------------------------------
        TEST_TITLE("cipher of an encrypted repo");

        StringList *argListEncrypt = strLstNew();
        hrnCfgArgRawZ(argListEncrypt, cfgOptRepoPath, TEST_PATH "/repo4");
        hrnCfgArgKeyRawStrId(argListEncrypt, cfgOptRepoCipherType, 1, cipherTypeAes256Cbc);
        hrnCfgEnvKeyRawZ(cfgOptRepoCipherPass, 1, TEST_CIPHER_PASS);
        HRN_CFG_LOAD(cfgCmdList, argListEncrypt);

        HRN_INFO_PUT(
            storageTest, TEST_PATH "/repo4/" STORAGE_PATH_BACKUP "/gamma/" INFO_BACKUP_FILE,
            "[db]\n"
            "db-catalog-version=202209061\n"
            "db-control-version=1300\n"
            "db-id=1\n"
            ...
            "\n"
            "[cipher]\n"
            "cipher-pass=\"xbackupx\"\n"
            "\n"
            "[db:history]\n"
            "1={\"db-catalog-version\":202209061,\"db-control-version\":1300,\"db-system-id\":6569239123849665681"
            ",\"db-version\":\"15\"}\n",
            .cipherSpec = TEST_CIPHER_SPEC, .comment = "put backup info to file - gamma, repo4");
        ...
        TEST_RESULT_STR_Z(
            ...
            "----------------------------------------------------------------------------------------------------------------------"
            "-------------------------------\n"
            " Repo   Version  ID                Recovery Time             Type  Cipher       TLI  Time  DB size  Backup size  Zrati"
            "o  Start LSN  Stop LSN   Status\n"
            "----------------------------------------------------------------------------------------------------------------------"
            "-------------------------------\n"
            " repo1  15       20260810-010001F  2026-01-21 12:53:30+0000  full  aes-256-cbc  1/0   10s      2KB          1KB    2.0"
            "0  1/1000028  1/10000F8  OK\n",
            "encrypted repo");
