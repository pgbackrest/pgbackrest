...
testRun(void)
{
    ...
    if (testBegin("helpRender()"))
    {
        ...
        commandHelp = zNewFmt(
            ...
            "Command Options:\n"
            "\n"
            "  --archive-mode                        preserve or disable archiving on\n"
            "                                        restored cluster [default=preserve]\n"
            "  --db-exclude                          restore excluding the specified\n"
            "                                        databases\n"
            ...
            "  --repo-host-ca-file                   repository host certificate authority\n"
            "                                        file\n"
            "  --repo-host-ca-path                   repository host certificate authority\n"
            "                                        path\n"
            "  --repo-host-cert-file                 repository host certificate file\n"
            "  --repo-host-cmd                       repository host pgBackRest command\n"
            "                                        [default=/path/to/pgbackrest]\n"
            "  --repo-host-config                    pgBackRest repository host\n"
            "                                        configuration file\n"
            "                                        [default=/etc/pgbackrest/pgbackrest.conf]\n"
            "  --repo-host-config-include-path       pgBackRest repository host\n"
            "                                        configuration include path\n"
            "                                        [default=/etc/pgbackrest/conf.d]\n"
            "  --repo-host-config-path               pgBackRest repository host\n"
            "                                        configuration path\n"
            "                                        [default=/etc/pgbackrest]\n"
            "  --repo-host-key-file                  repository host key file\n"
            "  --repo-host-port                      repository host port when repo-host is\n"
            "                                        set\n"
            "  --repo-host-type                      repository host protocol type\n"
            "                                        [default=ssh]\n"
            "  --repo-host-user                      repository host user when repo-host is\n"
            "                                        set [default=pgbackrest]\n"
            "  --repo-path                           path where backups and archive are\n"
            ...
            "  --repo-sftp-known-host                known hosts file to search\n"
            ...
            "  --repo-sftp-strict-host-key-checking  manage host key matching for the SFTP\n"
            "                                        host [default=yes]\n"
