...
testRun(void)
{
    ...
    if (testBegin("helpRender()"))
    {
        ...
        commandHelp = strZ(strNewFmt(
            ...
            "documentation. See the PostgreSQL documentation: Making a Base Backup Using the\n"
            "Low Level API (subsection Backing Up The Data Directory) for more information.\n"
            "\n"
            "Command Options:\n"
            "\n"
