...
testRun(void)
{
    ...
    if (testBegin("pgValidate(), online=y"))
    {
        ...
        harnessLogResult(
            "P00   INFO: beginning stanza-upgrade for stanza 'db' on repo1\n"
...
//         harnessLogResult("P00   INFO: stanza 'db' is already up to date");
        ...
        TEST_ERROR_FMT(
            ...
            "HINT: this may be a symptom of repository corruption!");
        harnessLogResult("P00   INFO: beginning stanza-upgrade for stanza 'db' on repo1");
    ...
    if (testBegin("cmdStanzaDelete(), stanzaDelete(), manifestDelete()"))
    {
        ...
        harnessLogResult("P00   INFO: beginning stanza-create for stanza 'otherstanza' on repo1");
