...
testRun(void)
{
    ...
    if (testBegin("infoRender()"))
    {
        ...
        // backup.info
// CSHANG Keep above comment and combine with lock held comment then remove this test as a dup. No code coverage is lost in doing so.
        // TEST_RESULT_STR_Z(
        //     infoRender(),
        //     "["
        //         "{"
        ...
        TEST_RESULT_VOID(
            storagePutP(
                ...
                harnessInfoChecksum(content)),
            "put backup info to file");
// CSHANG Remove below and combine with lock held test
        // TEST_RESULT_STR_Z(
        //     infoRender(),
        //     "["
        //         "{"
