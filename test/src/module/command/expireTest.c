...
testRun(void)
{
    ...
    String *backupInfoFileName = strNew("repo/backup/db/backup.info");
...
//     }
    ...
    if (testBegin("expireFullBackup()"))
    {
        ...
        TEST_RESULT_UINT(expireFullBackup(infoBackup), 3, "retention-full=2 - one full backup expired");
        TEST_RESULT_UINT(infoBackupDataTotal(infoBackup), 3, "  current backups reduced by 1 full and its dependencies");
        TEST_RESULT_STR(
            strPtr(strLstJoin(infoBackupDataLabelListP(infoBackup), ", ")),
            "20181119-152800F, 20181119-152900F, 20181119-152900F_20181119-152600D", "  remaining backups correct");
        harnessLogResult(
            "P00   INFO: expire full backup set: "
            "20181119-152138F, 20181119-152138F_20181119-152152D, 20181119-152138F_20181119-152155I");
    }
