...
testRun(void)
{
    ...
    if (testBegin("cfgLoadUpdateOption()"))
    {
        ...
        argList = strLstNew();
        hrnCfgArgRawZ(argList, cfgOptRepo, "2");
        hrnCfgArgKeyRaw(argList, cfgOptRepoType, 1, strIdToStr(STORAGE_CIFS_TYPE));
        hrnCfgArgKeyRaw(argList, cfgOptRepoType, 2, strIdToStr(STORAGE_CIFS_TYPE));
        TEST_ERROR(
        ...
        argList = strLstNew();
        hrnCfgArgRawZ(argList, cfgOptRepo, "1");
        hrnCfgArgKeyRaw(argList, cfgOptRepoType, 1, strIdToStr(STORAGE_POSIX_TYPE));
        hrnCfgArgKeyRaw(argList, cfgOptRepoType, 2, strIdToStr(STORAGE_CIFS_TYPE));
