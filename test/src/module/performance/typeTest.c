...
/***********************************************************************************************************************************
Driver to test manifestNewBuild()
***********************************************************************************************************************************/
typedef struct
{
...
testRun(void)
{
    ...
    // Build larger manifest to test performance and memory usage. The default sizing is for a "typical" cluster but this can be
    // scaled to test larger cluster sizes.
    // *****************************************************************************************************************************
