...
testRun(void)
{
    ...
    if (testBegin("storageLinkCreate()"))
    {
        ...
        TEST_RESULT_VOID(storageLinkCreateP(storageTest, emptyFile, latestLabel, storageHardLink), "hardlink to empty file");
        ...
        TEST_ERROR(
            storageLinkCreateP(storageTest, backupLabel, latestLabel, storageHardLink), FileOpenError,
