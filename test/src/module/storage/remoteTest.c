...
testRun(void)
{
    ...
    if (testBegin("storageNew()"))
    {
        ...
        // -------------------------------------------------------------------------------------------------------------------------
        TEST_RESULT_BOOL(
            storageRemoteProtocol(PROTOCOL_COMMAND_STORAGE_FEATURE_STR, NULL, server), true, "protocol feature");
        TEST_RESULT_STR(
        ...
        // -------------------------------------------------------------------------------------------------------------------------
        TEST_RESULT_BOOL(storageRemoteProtocol(strNew(BOGUS_STR), NULL, server), false, "invalid function");
    }
