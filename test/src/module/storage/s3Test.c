        ...
        HRN_FORK_BEGIN()
        {
            ...
            HRN_FORK_PARENT_BEGIN()
            {
                ...
                TEST_RESULT_STR_Z(
                    strNewBuf(
                        storageGetP(
                            storageNewReadP(s3, STRDEF("file.txt"), .rangeList = STGRNGLSTDEF(1, VARUINT64(29))))),
                ...
                TRY_BEGIN()
                {
                    storageGetP(storageNewReadP(s3, STRDEF("file.txt"), .rangeList = STGRNGLSTDEF(1, VARUINT64(29))));
                }
                CATCH_ANY()
                {
                    errorCaught = true;
        ...
        HRN_FORK_BEGIN()
        {
            ...
            HRN_FORK_PARENT_BEGIN()
            {
                ...
                TEST_RESULT_STR_Z(
                    strNewBuf(
                        storageGetP(
                            storageNewReadP(s3, STRDEF("file.txt"), .rangeList = STGRNGLSTDEF(1, VARUINT64(21))))),
