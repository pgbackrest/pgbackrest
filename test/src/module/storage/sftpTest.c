...
/*
    harnessLibssh2ScriptSet((HarnessLibssh2 [])
    {
        ...
        {.function = HRNLIBSSH2_SESSION_INIT},
        {.function = NULL}
    });
...
//    const String *writeFile = STRDEF(TEST_PATH "/writefile");
    ...
    if (testBegin("storageNew()"))
    {
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            ...
            {.function = HRNLIBSSH2_SESSION_HANDSHAKE, .param = "[5]", .resultInt = LIBSSH2_ERROR_EAGAIN},
            {.function = HRNLIBSSH2_SESSION_HANDSHAKE, .param = "[5]", .resultInt = -1},
            {.function = NULL}
        });
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            {.function = HRNLIBSSH2_INIT, .param = "[0]", .resultInt = 0},
            {.function = HRNLIBSSH2_SESSION_INIT_EX, .param = "[null,null,null,null]"},
            {.function = HRNLIBSSH2_SESSION_HANDSHAKE, .param = "[5]", .resultInt = LIBSSH2_ERROR_EAGAIN, .sleep = 1000},
            {.function = HRNLIBSSH2_SESSION_HANDSHAKE, .param = "[5]", .resultInt = LIBSSH2_ERROR_EAGAIN},
            {.function = NULL}
        });
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            {.function = HRNLIBSSH2_INIT, .param = "[0]", .resultInt = 0},
            {.function = HRNLIBSSH2_SESSION_INIT_EX, .param = "[null,null,null,null]"},
            {.function = HRNLIBSSH2_SESSION_HANDSHAKE, .param = "[5]", .resultInt = 0},
        ...
        TEST_ERROR(
            storageSftpNewP(TEST_PATH_STR, STRDEF("localhost"), 22, 5000, 5000, .user = TEST_USER_STR,
                .keyPriv = STRDEF("/home/vagrant/.ssh/id_rsa"), .keyPub = STRDEF("/home/vagrant/.ssh/authorized_keys")),
            ServiceError, "libssh2 hostkey hash failed");
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            ...
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
                .param = "[\"vagrant\",7,\"/home/vagrant/.ssh/authorized_keys\",\"/home/vagrant/.ssh/id_rsa\",null]",
                .resultInt = -16},
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            ...
            {.function = HRNLIBSSH2_HOSTKEY_HASH, .param = "[2]", .resultZ = "adummyhash12345"},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
                .param = "[\"vagrant\",7,null,\"/home/vagrant/.ssh/id_rsa\",null]",
                .resultInt = -16},
            {.function = HRNLIBSSH2_SFTP_LAST_ERROR, .resultUInt = 0},
            {.function = NULL}
        });
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            ...
            {.function = HRNLIBSSH2_HOSTKEY_HASH, .param = "[2]", .resultZ = "adummyhash12345"},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
                .param = "[\"vagrant\",7,\"/home/vagrant/.ssh/authorized_keys\",\"/home/vagrant/.ssh/id_rsa\",\"keyPassphrase\"]",
                .resultInt = -16},
            {.function = HRNLIBSSH2_SFTP_LAST_ERROR, .resultUInt = 0},
            {.function = NULL}
        });
        ...
        TEST_ERROR(
            storageSftpNewP(TEST_PATH_STR, STRDEF("localhost"), 22, 1000, 1000, .user = TEST_USER_STR,
                .keyPub = STRDEF("/home/vagrant/.ssh/authorized_keys")), ParamRequiredError, "user and private key required");
        ...
        // Free context, otherwise callbacks to libssh2SessionFreeResource() build up
        memContextFree(objMemContext((StorageSftp *)storageDriver(storageTest)));

        // -------------------------------------------------------------------------------------------------------------------------
        TEST_TITLE("sftp session init success timeout");

        // jrt !!! need to determin how to set FD for tests.
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            {.function = HRNLIBSSH2_INIT, .param = "[0]", .resultInt = 0},
            {.function = HRNLIBSSH2_SESSION_INIT_EX, .param = "[null,null,null,null]"},
...
//        TEST_CREATE_NOPERM();
        ...
        harnessLibssh2ScriptSet((HarnessLibssh2 [])
        {
            ...
            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE},
//            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_FX_NO_SUCH_FILE},
//            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE},
//            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE},
...
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE},
//            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE, .sleep = 250},
//            {.function = HRNLIBSSH2_SFTP_STAT_EX, .param = "[\"/home/vagrant/test/test-0/exists\",32,0]",
//                .attrPerms = LIBSSH2_SFTP_S_IFREG, .resultInt = LIBSSH2_ERROR_NONE, .sleep = 250},
 ...
 //       TEST_REMOVE_NOPERM();
        ...
        // jrt !!! -- don't actually need to create the files, shim returns what we want
        //    can remove all TEST_CONTAINER_REQUIRED wrappers
