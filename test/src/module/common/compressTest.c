...
testRun(void)
{
    ...
    // *****************************************************************************************************************************
    if (testBegin("compressInit() and compressExt*()"))
    {
        ...
        TEST_RESULT_VOID(compressFilterAdd(filterGroup), "try to add filter");
        ...
        TEST_ERROR(compressExtZ(), AssertError, "    check ext");
#endif
