...
sub run
{
    ...
    (
        ...
        {pg => PG_VERSION_10, repoDest =>     HOST_BACKUP, storage =>    S3, encrypt =>  true, compress =>   GZ},
        {pg => PG_VERSION_11, repoDest => HOST_DB_STANDBY, storage => AZURE, encrypt => false, compress =>  ZST},
