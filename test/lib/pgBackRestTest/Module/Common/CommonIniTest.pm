...
sub run
{
    ...
    if ($self->begin("Ini->new()"))
    {
        ...
        $self->testException(
            ...
            "unable to open '${strTestFile}': No such file or directory");
        ...
        storageTest()->put($strTestFileCopy, iniRender($oIni->{oContent}));
